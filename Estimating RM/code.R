...
b6=lm(RM~I((MRM/Index)^6) + MRM:CountGroup + MRM:Action + MRM:CountGroup:Count - 1+
        MRM:CountGroup:Count:Action,data)
b6 %>% all()
...
obj+
  ...
  geom_point(aes(x=MRM,y=RM,col=BodyType,shape=Action),size=4)+
