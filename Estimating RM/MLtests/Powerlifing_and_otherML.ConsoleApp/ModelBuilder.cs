...
namespace Powerlifing_and_otherML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\qtckp\OneDrive\Рабочий стол\Powerlift\Estimating RM\MLtests\data.csv";
        private static string MODEL_FILEPATH = @"C:\Users\qtckp\AppData\Local\Temp\MLVSTools\Powerlifing_and_otherML\Powerlifing_and_otherML.Model\MLModel.zip";
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.Regression.CrossValidate(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "RM");
